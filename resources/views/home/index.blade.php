...
<head>
    ...
    <title>新光VR</title>
    <link rel="stylesheet" href="{{asset('home/hui/css/hui.min.css')}}">
    <link rel="stylesheet" href="{{asset('home/hui/fonts/iconfont.min.css')}}">
    <link rel="stylesheet" href="{{asset('home/css/iconfont.css')}}">
    <link rel="stylesheet" href="{{asset('home/hui/css/animate.min.css')}}">
    <link rel="stylesheet" href="{{asset('home/hui/css/swiper.min.css')}}">
    <link rel="stylesheet" href="{{asset('home/css/common.css')}}">
    <link rel="stylesheet" href="{{asset('home/css/index.css')}}">
    <!--[if lt IE 9]>
        <script type="text/javascript" src="{{asset('home/hui/js/html5shiv.js')}}"></script>
        <script type="text/javascript" src="{{asset('home/hui/js/respond.min.js')}}"></script>
    <![endif]-->
</head>
...
<body>
    ...
    <footer>
            ...
            <div class="container wow bounceInUp">
                <div class="row cl footer_text">
                    <div class="col-sm-4 col-xs-12">
                        <p>重庆晨科信息技术有限公司</p>
                        <p><span>客服电话：023-88372090</span></p>
                    </div>
                    <div class="col-sm-4 col-xs-12">
                        <p>地址</p>
                        <p><span>重庆市渝中区重庆天地</span></p>
                    </div>
        ...
        <div class="copyright wow bounceInUp">
            <div class="container">CopyRight© 2018重庆晨科信息技术有限公司All Rights Reserved <span style="padding-left: 100px">备案/许可证编号为：渝ICP备18011676号</span></div>
        </div>
    </footer>
